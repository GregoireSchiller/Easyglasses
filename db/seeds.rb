...
Question.create(position: 1, orientation: 3, size: 350)
Question.create(position: 2, orientation: 4, size: 180)
Question.create(position: 3, orientation: 2, size: 90)
Question.create(position: 4, orientation: 1, size: 45)
Question.create(position: 5, orientation: 2, size: 20)
Question.create(position: 6, orientation: 4, size: 90)
Question.create(position: 7, orientation: 3, size: 45)
Question.create(position: 8, orientation: 1, size: 45)
Question.create(position: 9, orientation: 3, size: 20)
Question.create(position: 10, orientation: 4, size: 20)
Question.create(position: 11, orientation: 2, size: 350)
Question.create(position: 12, orientation: 3, size: 180)
Question.create(position: 13, orientation: 2, size: 90)
Question.create(position: 14, orientation: 1, size: 45)
Question.create(position: 15, orientation: 4, size: 20)
Question.create(position: 16, orientation: 3, size: 90)
Question.create(position: 17, orientation: 1, size: 45)
Question.create(position: 18, orientation: 2, size: 45)
Question.create(position: 19, orientation: 3, size: 20)
Question.create(position: 20, orientation: 4, size: 20)
